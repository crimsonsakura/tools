...
$addOrder = "insert into orderdata(order_title,order_class,order_img,order_time,order_price,order_content,order_lendtime,order_address)values(:order_title,:order_class,:order_img,:order_time,:order_price,:order_content,:order_lendtime,:order_address)";
